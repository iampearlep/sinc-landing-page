...
const Footer = () => {
  return (
    <div className="bg-[#212121] flex flex-col justify-center items-center mx-auto">
     <div className="flex flex-col justify-start items-start text-[#ffffff] border-t md:border-t-0 border-b">
        <div className="grid grid-cols-2 md:grid-cols-6 w-11/12 md:w-10/12 mx-auto">
            <div className="flex flex-col gap-y-8 py-5 md:py-10 px-5 col-span-2 md:col-span-1">
                <div>
                <Link href="/">
                <Image
                src={Logo}
           ...
           to amazing startups in exchange for minute equity (usually 0.5% to 2%)
            ...
            <div className="flex flex-col gap-y-8 py-5 md:py-10 px-5">
...
Career
        ...
        <Link href=""><p>Services</p></Link>
           ...
           <Link href=""><p>Press</p></Link>
            ...
            <div className="flex flex-col gap-y-8 border-t md:border-t-0 col-span-2 md:col-span-1 md:border-l border-[#e9e9e9] py-10 px-5">
              ...
              <div className="flex flex-col gap-y-6 text-[14px] text-[#a4a4a4]" >  <p>Abuja, Nigeria </p>
                ...
                <div className="flex flex-row justify-center items-end py-5 md:py-10">
                    <div>
                    <Image
                src={F1Img}
                height={66}
     ...
     <div className=" text-xs py-8 flex flex-col md:flex-row justify-between gap-y-6 items-center w-11/12 md:w-10/12">
        <div>
           ...
           <div className="text-[#ffffff] flex flex-col md:flex-row gap-y-6 justify-between pt-7 md:pt-14">
           <p>&copy; 2023 SINC Partners Ltd. All rights reserved</p>
            <div className="flex flex-row gap-x-2 md:gap-x-8 underline justify-between items-center">
